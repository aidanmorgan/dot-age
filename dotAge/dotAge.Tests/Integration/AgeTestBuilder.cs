    ...
    public class AgeTestBuilder : IDisposable
    {
        ...
        public AgeTestBuilder GenerateKeys()
        {
            if (_useAgeKeygen)
            {
                ...
                var keyFileContent = File.ReadAllText(_keyFile);
                _privateKeyLine = keyFileContent.Split('\n')[0].Trim();
                var publicKeyLineWithPrefix = keyFileContent.Split('\n')[1].Trim();
                // Extract the actual public key (format: "# public key: age1...")
                _publicKeyLine = publicKeyLineWithPrefix.Split(':')[1].Trim();
            }
        ...
        /// <summary>
        /// Encrypts the plaintext file using dotAge with streams.
        /// </summary>
        /// <returns>The builder instance for method chaining.</returns>
        public AgeTestBuilder EncryptWithDotAgeStream()
        {
            _encryptionAge.EncryptFileWithStreams(_plaintextFile, _ciphertextFile);
            return this;
        }
        ...
        /// <summary>
        /// Decrypts the ciphertext file using dotAge with streams.
        /// </summary>
        /// <returns>The builder instance for method chaining.</returns>
        public AgeTestBuilder DecryptWithDotAgeStream()
        {
            _decryptionAge.DecryptFileWithStreams(_ciphertextFile, _decryptedFile);
            return this;
        }
